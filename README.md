...
The function 'can' takes two arguments, a DyckWord and a Permutation, and returns a list. This list is the canon permutation associated to the Dyck path and permutation. 
The function 'is_contained' takes two arguments, both of type DyckWord, and returns a bool. This checks if the first Dyck path is contained in the second, i.e., if the first Dyck path is always under the second when drawn in the plane.
